...
aws s3 cp ./build s3://dinosaur.design --content-encoding gzip --content-type text/javascript --recursive --exclude "*" --include "*.js" --cache-control max-age=31536000
aws s3 cp ./build s3://dinosaur.design --content-encoding gzip --content-type text/css --recursive --exclude "*" --include "*.css" --cache-control max-age=31536000
aws s3 cp ./build s3://dinosaur.design --content-encoding gzip --content-type text/html --recursive --exclude "*" --include "*.html" --cache-control max-age=31536000
